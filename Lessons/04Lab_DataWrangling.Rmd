...
NTL.phys.data.Tues90.Tues99 <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 %in% c(1990:1999))

NTL.phys.data.Tues90.Tues99
```
...
NTL.phys.dataTues1990.July1999<-NTL.phys.data %>% filter(lakename)
